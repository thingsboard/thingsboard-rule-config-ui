...
import TransactionBeginConfigDirective from "./transaction-begin-config.directive";
...
export default angular.module('thingsboard.ruleChain.config.action', [])
    ...
    .directive('tbActionNodeTransactionBeginConfig', TransactionBeginConfigDirective)
    .name;
