...
import clearAlarmConfigTemplate from './clear-alarm-config.tpl.html';

/* eslint-enable import/no-unresolved, import/default */

/*@ngInject*/
export default function ClearAlarmConfigDirective($compile, $translate, types, ruleNodeScriptTest) {

    var linker = function (scope, element, attrs, ngModelCtrl) {
        var template = clearAlarmConfigTemplate;
